      ...
      <TabPanel value={value} index={1}>
        <Typography variant="h8" color="text.secondary">
          <TableContainer component={Paper}>
            <Table sx={{ minWidth: 650, backgroundColor: '#eb525c' }} aria-label="simple table">
              <TableHead>
                <TableRow sx={{ backgroundColor: '#ed212f' }}>
                  ...
                  <TableCell align="right">Valor medido de gás</TableCell>
