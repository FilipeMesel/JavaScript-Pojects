...
import { CalendarMonth, Settings, SupportAgent, TimeToLeave } from '@mui/icons-material';
      ...
      <AppBar position="fixed" open={open}>
        <Toolbar sx={{backgroundColor:"gray"}}>
          ...
          <Typography variant="h5" noWrap component="div">
            ...
            <Button variant="text" onClick={()=>window.location.reload(true)}  sx={{ backgroundColor: 'gray', color: 'white' }} >LOCACAR DASHBOARD</Button>
        ...
        <List>
           ...
           <ListItem onClick={()=>setVisivel(5)} key={5} disablePadding>
              <ListItemButton>
                ...
                <ListItemText primary={"Cadastro de Carros"} />
              </ListItemButton>
            </ListItem>
